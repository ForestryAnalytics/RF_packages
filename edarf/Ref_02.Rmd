...
n two dimensional integer vector giving the resolution of the grid. the first element
gives the grid on vars and the second on the other columns, which are
subsampled.
interaction logical, if ’vars’ is a vector, does this specify an interaction or a list of bivariate
partial dependence
uniform logical, indicates whether a uniform or random grid is to be construct partial
